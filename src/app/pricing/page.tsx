...
const page = async () => {
    ...
    return (
        <div
            className="relative min-h-screen bg-[#0a0a0f] selection:bg-cyan-500/20
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="text-center mb-24">
                        <div className="relative inline-block">
                            <div className="absolute -inset-px bg-gradient-to-r from-cyan-500 to-teal-500 blur-xl opacity-20" />
                            <h1
                                className="relative text-5xl md:text-6xl lg:text-7xl font-extrabold bg-gradient-to-r 
            from-cyan-400 to-teal-500 text-transparent bg-clip-text mb-6 md:mb-8"
                            >
                                Empower Your Coding Journey
                            </h1>
                        </div>
                        <p className="text-xl text-gray-400 max-w-4xl mx-auto">
                            Unlock your full potential with our cutting-edge tools and resources, designed to accelerate your growth as a developer.
                        </p>
                    </div>
                        ...
                        {ENTERPRISE_FEATURES.map((feature) => (
                            ...
                            >
                                <div className="relative">
                                    <div
                                        className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-500/10 to-teal-500/10 
                        flex items-center justify-center mb-4 ring-1 ring-gray-800/60 group-hover:ring-cyan-500/20"
                                    >
                    ...
                    <div className="relative max-w-4xl mx-auto">
                        <div
                            className="absolute -inset-px bg-gradient-to-r from-cyan-500
                   to-teal-500 rounded-2xl blur opacity-10"
                        />
                    ...
                    from-transparent via-cyan-500/50 to-transparent"
                            ...
                            <div className="relative p-8 md:p-12">
                                ...
                                <div className="text-center mb-12">
                                    <div className="inline-flex p-3 rounded-xl bg-gradient-to-br from-cyan-500/10 to-teal-500/10 ring-1 ring-gray-800/60 mb-6">
