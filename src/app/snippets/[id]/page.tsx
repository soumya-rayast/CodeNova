        ...
        <div className="bg-[#121218] border border-[#ffffff0a] rounded-2xl p-6 sm:p-8 mb-6 backdrop-blur-xl">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
            <div className="flex items-center gap-4">
              <div className="flex items-center justify-center size-12 rounded-xl bg-gradient-to-r from-cyan-500/10 to-cyan-700/10 p-2.5">
                {/* <Image
            ...
            <div className="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-cyan-500/10 to-cyan-700/10 text-white rounded-lg text-sm font-medium">
              {snippet.language}
            </div>
          </div>
