    ...
    return (
        <div className='relative' ref={dropDownRef}>
            <motion.button
                ...
                className='w-48 relative flex items-center gap-2 px-4 py-2.5 bg-[#1e1e2e]/80 hover:bg-[#262637] rounded-lg transition-all duration-200 border border-gray-800/50 hover:border-gray-700'
            >
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className='absolute top-full left-0 mt-2 w-full min-w-[240px] bg-[#1e1e2e]/95 backdrop-blur-xl rounded-xl border-[#313244] shadow-2xl py-2 z-50'
                    >
                        ...
                        {THEMES.map((t, index) => (
                            ...
                            >
                                ...
                                <div
                                    className={`flex items-center size-8 rounded-l-lg 
                            ${theme === t.id ? 'bg-blue-500/10 text-blue-400' : 'bg-gray-800/5 text-gray-400'} group-hover:scale-110 transition-all duration-200`}
                                >
